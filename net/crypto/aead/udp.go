/*
 * @Date: 2022.03.02 15:12
 * @Description: Omit
 * @LastEditors: Rustle Karl
 * @LastEditTime: 2022.03.02 15:12
 */
...
// Unpack decrypts pkt using aead and returns a slice of dst containing the
// decrypted payload and any error occurred.
